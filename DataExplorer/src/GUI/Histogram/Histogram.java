...
public class Histogram extends JFrame implements IPlot {
	...
	public Histogram(Vector variables, String name,
			double[] data) {
		super(name);
		this.name = name;
		...
		SelectionManager.gerSelectionManager().windows.add(this);
	...
	public Histogram(ISelectable object) {
		super(object.getName());
		this.name = object.getName();
		panel = new HistogramPanel(this, IData.getIData(),  object.getVariables(),name, object.getDoubleData());
...
class HistogramPanel extends JPanel implements KeyListener, MouseListener,
	...
	public HistogramPanel(Histogram hist, IData amlTool,
...
*/			
		...
		if (selected) { 
			if (variables.elementAt(0) instanceof Case || variables.elementAt(0) instanceof AnnGene || variables.elementAt(0) instanceof Clone) {
				seurat.dataManager.selectExperiments(); 
			}
			if (variables.elementAt(0) instanceof Variable || variables.elementAt(0) instanceof CGHVariable) {
				seurat.dataManager.selectGenesClones(); 
